...
public class Utils {
  ...
  public static ArrayList<NounPhrase> extractNounPhrases(ArrayList<Token> tokenList, JCas jCas) {
  ...
  public static ArrayList<NER> extractNER(String tagged, JCas jCas) throws Exception {
