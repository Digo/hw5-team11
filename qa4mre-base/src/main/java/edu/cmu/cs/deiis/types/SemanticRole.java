...
public class SemanticRole extends Annotation {
  ...
  /** getter for Label - gets Semantic role played by the predicate argument or
              target
   * @generated */
  public String getLabel() {
    if (SemanticRole_Type.featOkTst && ((SemanticRole_Type)jcasType).casFeat_Label == null)
      jcasType.jcas.throwFeatMissing("Label", "edu.cmu.cs.deiis.types.SemanticRole");
    return jcasType.ll_cas.ll_getStringValue(addr, ((SemanticRole_Type)jcasType).casFeatCode_Label);}
    
  /** setter for Label - sets Semantic role played by the predicate argument or
              target 
   * @generated */
  ...
  /** getter for sequenceNumber - gets This is necessary to work around the default sorting
              within
  ...
  public int getSequenceNumber() {
    if (SemanticRole_Type.featOkTst && ((SemanticRole_Type)jcasType).casFeat_sequenceNumber == null)
      jcasType.jcas.throwFeatMissing("sequenceNumber", "edu.cmu.cs.deiis.types.SemanticRole");
    return jcasType.ll_cas.ll_getIntValue(addr, ((SemanticRole_Type)jcasType).casFeatCode_sequenceNumber);}
    
  /** setter for sequenceNumber - sets This is necessary to work around the default sorting
              within
              the CAS. We'll keep our own sort order, thankyouverymuch. 
   * @generated */
  ...
  public SemanticRole getParent() {
    if (SemanticRole_Type.featOkTst && ((SemanticRole_Type)jcasType).casFeat_Parent == null)
      jcasType.jcas.throwFeatMissing("Parent", "edu.cmu.cs.deiis.types.SemanticRole");
