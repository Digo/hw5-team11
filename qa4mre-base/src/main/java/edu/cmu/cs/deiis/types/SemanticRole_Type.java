...
public class SemanticRole_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.cs.deiis.types.SemanticRole");
  ...
  public String getLabel(int addr) {
      ...
      jcas.throwFeatMissing("Label", "edu.cmu.cs.deiis.types.SemanticRole");
  ...
  public int getSequenceNumber(int addr) {
      ...
      jcas.throwFeatMissing("sequenceNumber", "edu.cmu.cs.deiis.types.SemanticRole");
  ...
  public int getParent(int addr) {
      ...
      jcas.throwFeatMissing("Parent", "edu.cmu.cs.deiis.types.SemanticRole");
  ...
  public int getChildren(int addr) {
      ...
      jcas.throwFeatMissing("Children", "edu.cmu.cs.deiis.types.SemanticRole");
  ...
  public SemanticRole_Type(JCas jcas, Type casType) {
    ...
    casFeat_Parent = jcas.getRequiredFeatureDE(casType, "Parent", "edu.cmu.cs.deiis.types.SemanticRole", featOkTst);
